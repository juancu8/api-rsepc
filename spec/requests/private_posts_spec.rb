...
RSpec.describe "Posts with authentication", type: :request do 
  ...
  # Authorization: Bearer xxxxxxx || convection
  ...
  describe "PUT /posts" do
    ...
    context "with valid auth" do
      # update own post
      context "when user's updating own post" do
      ...
      # !update other user post -> 401
      context "when user's updating other user post" do
